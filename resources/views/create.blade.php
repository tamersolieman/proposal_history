...
<div class="container">
  ...
  <form class="form-horizontal" action="index" method="POST">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" id="project_name" name="project_name" placeholder="Enter project name" {{-- required="Project Name is required" --}}>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" id="contact_name"  name="contact_name" placeholder="Enter contact name" {{-- required="Contact name is required" --}}>
      </div>
    </div>
    <div class="form-group">
